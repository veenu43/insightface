...
class ImageReader(object):
    ...
    def __next__(self):
        ...
        self.idx += 1
        print(f"img: {img}, file_name: {file_name}")
...
def main(args=None):
    ...
    # general
    parser1.add_argument('--model-prefix', default='', help='path to load model.')
    parser1.add_argument('--model-epoch', default=1, type=int, help='')
    parser1.add_argument('--gpu', default=7, type=int, help='gpu id')
    parser1.add_argument('--batch-size', default=32, type=int, help='')
    parser1.add_argument('--job', default='insightface', type=str, help='job name')
    parser1.add_argument('--target',
                         default='IJBC',
                         type=str,
                         help='target, set to IJBC or IJBB')
    args =  parser().parse_args()
    args.input = "./datasets/elon.jpg"
    args.det = True
    args.rec = True
